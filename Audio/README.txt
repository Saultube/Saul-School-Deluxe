...
DrinkElixir->Sfx_DrinkElixir(Sfx_DrinkElixir) | DrinkElixir
GloveSnapOn->Sfx_GloveSnapOn(Sfx_GloveSnapOn) | GloveSnapOn
...
BalloonBuster_Pulley->Sfx_BalloonBuster_Pulley(Sfx_BalloonBuster_Pulley) | BalloonBuster_Pulley
...
Crane_ClawGrab->Sfx_Crane_ClawGrab(Sfx_Crane_ClawGrab) | Crane_ClawGrab
Crane_Lifting->Sfx_Crane_Lifting(Sfx_Crane_Lifting) | Crane_Lifting
Crane_Running->Sfx_Crane_Running(Sfx_Crane_Running) | Crane_Running
Crane_Thunk->Sfx_Crane_Thunk(Sfx_Crane_Thunk) | Crane_Thunk
CrowdChatter->*Chattering*(Sfx_CrowdChatter) | CrowdChatter
...
ElectricBuzz->*Electric humming*(Sfx_ElectricBuzz) | ElectricBuzz
...
MatchBalloon_Revealed->Sfx_MatchBalloon_Revealed(Sfx_MatchBalloon_Revealed) | MatchBalloon_Revealed
MatchShaft_Pulse->Sfx_MatchShaft_Pulse(Sfx_MatchShaft_Pulse) | MatchShaft_Pulse
...
PacketOMatic_Run->Sfx_PacketOMatic_Run(Sfx_PacketOMatic_Run) | PacketOMatic_Run
PlateDrop->Sfx_PlateDrop(Sfx_PlateDrop) | PlateDrop
PlateLift->Sfx_PlateLift(Sfx_PlateLift) | PlateLift
PowerAlarm_Raw->*ALARM*(Sfx_PowerAlarm) | PowerAlarm_Raw
PowerAlarm_Reverb->*ALARM*(Sfx_PowerAlarm) | PowerAlarm_Reverb
PowerBreaker_Ambient->Sfx_PowerBreaker_Ambient(Sfx_PowerBreaker_Ambient) | PowerBreaker_Ambient
PowerBreaker_LightsOn->Sfx_PowerBreaker_LightsOn(Sfx_PowerBreaker_LightsOn) | PowerBreaker_LightsOn
PowerBreaker_Motor_Intro->*Generator motor running*(Sfx_PowerMotor) | PowerBreaker_Motor_Intro
PowerBreaker_Motor_Loop->*Generator motor running*(Sfx_PowerMotor) | PowerBreaker_Motor_Loop
PowerBreaker_Motor_Off->*Generator motor running*(Sfx_PowerMotor) | PowerBreaker_Motor_Off
PowerBreaker_Reset->Sfx_PowerBreaker_Reset(Sfx_PowerBreaker_Reset) | PowerBreaker_Reset
...
StickerPacket_Open->Sfx_StickerPacket_Open(Sfx_StickerPacket_Open) | StickerPacket_Open
...
Valve->Sfx_Valve(Sfx_Valve) | Valve
ValveIsOpen->*hissing*(Sfx_ValveLeak) | ValveIsOpen
ValveLeak->*hissing*(Sfx_ValveLeak) | ValveLeak
...
WormholeOpen->*...woooooooOOOOOOOOSSH!*(Sfx_WormholeOpen) | WormholeOpen
...
BAL_Event_BalderDash->Watch out!(Vfx_BAL_Event_BalderDash_0) | BAL_Event_BalderDash
...
BAL_Event_StudentShuffle->Hey everyone!(Vfx_BAL_Event_StudentShuffle_0) | BAL_Event_StudentShuffle
...
BAL_FoundLocker->I know you're in there!(Vfx_BAL_FoundLocker) | BAL_FoundLocker
...
BAL_Tutorial_Activities->Some notebooks are locked behind tricky activities(Vfx_BAL_Tutorial_Activities_0) | BAL_Tutorial_Activities
BAL_Tutorial_Activities_Incorrect->Uh oh...(Vfx_BAL_Tutorial_Activities_Incorrect_0) | BAL_Tutorial_Activities_Incorrect
BAL_Tutorial_AllNotebooks->Congratulations! You found all the notebooks!(Vfx_BAL_Tutorial_AllNotebooks_0) | BAL_Tutorial_AllNotebooks
BAL_Tutorial_Characters->When you're playing my game, you'll get to meet all my friends!(Vfx_BAL_Tutorial_Characters_0) | BAL_Tutorial_Characters
BAL_Tutorial_Detention->WOAH!(Vfx_BAL_Tutorial_Detention_0) | BAL_Tutorial_Detention
BAL_Tutorial_Finished->Congratulations! You've finished my tutorial!(Vfx_BAL_Tutorial_Finished_0) | BAL_Tutorial_Finished
BAL_Tutorial_HideSeek->The tutorial is almost over, but this is where the fun begins!(Vfx_BAL_Tutorial_HideSeek_0) | BAL_Tutorial_HideSeek
BAL_Tutorial_Interact->You can interact with all sorts of things around my Super Schoolhouse!(Vfx_BAL_Tutorial_Interact_0) | BAL_Tutorial_Interact
BAL_Tutorial_Intro->Oh, hi! Welcome to the tutorial!(Vfx_BAL_Tutorial_Intro_0) | BAL_Tutorial_Intro
BAL_Tutorial_ItemsConclusion->WOOOOOAAAAAH!(Vfx_BAL_Tutorial_ItemsConclusion_0) | BAL_Tutorial_ItemsConclusion
BAL_Tutorial_ItemsIntro->While you're exploring my Super Schoolhouse you'll find all sorts of useful items!(Vfx_BAL_Tutorial_ItemsIntro_0) | BAL_Tutorial_ItemsIntro
BAL_Tutorial_ItemsSpraySoda->Great job!(Vfx_BAL_Tutorial_ItemsSpraySoda_0) | BAL_Tutorial_ItemsSpraySoda
BAL_Tutorial_LockedDoor->Uh oh! Looks like you'll need to find a button to open this door!(Vfx_BAL_Tutorial_LockedDoor_0) | BAL_Tutorial_LockedDoor
BAL_Tutorial_LockedDoor_Open->Would you look at that! The door's open now! Good job!(Vfx_BAL_Tutorial_LockedDoor_Open_0) | BAL_Tutorial_LockedDoor_Open
BAL_Tutorial_LookBackComplete->Woah, you've spotted me!(Vfx_BAL_Tutorial_LookBackComplete_0) | BAL_Tutorial_LookBackComplete
BAL_Tutorial_LookBackPrompt->Guess who!(Vfx_BAL_Tutorial_LookBackPrompt_0) | BAL_Tutorial_LookBackPrompt
BAL_Tutorial_Map->I think the button is at the end of this maze. Good thing you have a map!(Vfx_BAL_Tutorial_Map_0) | BAL_Tutorial_Map
BAL_Tutorial_MazeComplete->You did it! Hit the button and then hop into this vent.(Vfx_BAL_Tutorial_MazeComplete_0) | BAL_Tutorial_MazeComplete
BAL_Tutorial_Noise->Oh! I heard that!(Vfx_BAL_Tutorial_Noise_0) | BAL_Tutorial_Noise
BAL_Tutorial_NotebookCollected->Yeah, you got it!(Vfx_BAL_Tutorial_NotebookCollected_0) | BAL_Tutorial_NotebookCollected
BAL_Tutorial_Notebooks->The goal of my game is to find all the notebooks in each level!(Vfx_BAL_Tutorial_Notebooks_0) | BAL_Tutorial_Notebooks
BAL_Tutorial_Run->It's good to walk, but it's fun to run! To go faster, press and hold the "RUN" button while you move.(Vfx_BAL_Tutorial_Run_0) | BAL_Tutorial_Run
BAL_Tutorial_Stickers_0->Hey! While you're here, why don't you buy some stickers?(Vfx_BAL_Tutorial_Stickers_0_0) | BAL_Tutorial_Stickers_0
BAL_Tutorial_Stickers_1->Now that you've got some stickers, go use that machine with the glove.(Vfx_BAL_Tutorial_Stickers_1_0) | BAL_Tutorial_Stickers_1
BAL_Tutorial_Stickers_2->All riiiight! Now the effects of the stickers you applied have been activated!(Vfx_BAL_Tutorial_Stickers_2_0) | BAL_Tutorial_Stickers_2
BAL_Tutorial_Store->Well this looks like one tricky situation!(Vfx_BAL_Tutorial_Store_0) | BAL_Tutorial_Store
BAL_Tutorial_Tag->Aha! I tagged you!(Vfx_BAL_Tutorial_Tag_0) | BAL_Tutorial_Tag
BAL_Tutorial_ThatCouldDoIt->That could do the trick!(Vfx_BAL_Tutorial_ThatCouldDoIt) | BAL_Tutorial_ThatCouldDoIt
...
Student_Where->????????(Vfx_Student_Where) | Student_Where
Student_Yay->!!!!!!!!(Vfx_Student_Yay) | Student_Yay
